...
<div class="row">
    <div class="col-xs-12">
        ...
        <form class="form-horizontal" role="form" action="/dic/taggroup/save"
              method="post">
            ...
            <div class="form-group">
                <label for="filters" class="col-sm-2 control-label no-padding-right">filter：</label>
                <div class="col-sm-9">
                    <input
                            class="form-control limited" id="filters" name="filters" placeholder="json格式"
                            maxlength="50" value="${fn:escapeXml(vo.filters) }">
                    </textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <select class="form-control" id="groupdept" name="departmentIds" multiple="multiple" size="5">
            ...
            <div class="form-group">
                ...
                <label for="grouptags" class="col-sm-2 control-label no-padding-right">分组标签：</label>
                <div class="col-sm-4">
                    <select class="form-control" id="grouptags" multiple="multiple" size="10">
                        <c:forEach items="${categorys}" var="cat">
                            ...
                            <c:forEach items="${vo.groupCategories}" var="child">

                                <c:if test="${cat.categoryId eq child.categoryId}">
                ...
                <div class="col-sm-4">
                    <select class="form-control" id="choosedTags" multiple="multiple" size="10" name="categoryNames">
